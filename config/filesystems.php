...
return [
    ...
    */
    ...
    |                    "null", "azure", "copy", "dropbox", "gridfs", "memory",
    |                    "phpcr", "replicate", "vfs", "webdav", "zip", "bos",
    |                    "cloudinary", "eloquent", "fallback", "github",
    |                    "gdrive", "google", "mirror", "onedrive", "oss",
    |                    "qiniu", "redis", "runabove", "sae", "smb", "temp"
    |
    */
